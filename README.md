...
FauxProof protects approved writing, plans, prompts, instructions, and code from silent AI changes. Claude can compare a proposed revision with the protected version, save it for review, and apply it only after you explicitly approve it.

FauxProof provides exact differences, pending proposals, restore points, backups, and receipts. Its checks are deterministic; they do not guarantee that wording is factually or semantically correct.
...
FauxProof currently supports text-based material such as writing, plans, prompts, instructions, and code. This package does not claim native image, chart, or arbitrary-file comparison.
